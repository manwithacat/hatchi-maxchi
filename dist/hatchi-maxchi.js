...
/* HYPERPART: carousel */
/*
 * carousel — prev / next / dot activation for a server-marked strip.
 *
 * Contract:
 *   - root:   [data-carousel] (+ optional data-carousel-index)
 *   - slides: .carousel__slide — visible when [data-active]
 *   - prev:   [data-carousel-prev]
 *   - next:   [data-carousel-next]
 *   - dots:   .carousel__dot with aria-current on the active index
 *
...
(function () {
  ...
  document.addEventListener("click", function (evt) {
    ...
    var dot =
      t.closest(".carousel__dot") || t.closest(".carousel__dot");
