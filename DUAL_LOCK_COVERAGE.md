...
| Controllers | 34 |
| Contract modules | 146 |
| Dual-lock schema+DOM | 42 |
| Dual-lock DOM-only | 102 |
| Dual-lock deferred | 2 |
...
| `date` | `date.py` | `dz-date.js` | yes | no | no | **DOM-only** |
| `date_range` | `date_range.py` | `dz-date-range.js` | yes | yes | yes | **schema+DOM** |
...
| `kanban` | `kanban.py` | `dz-kanban.js` | yes | yes | yes | **schema+DOM** |
...
| `number` | `number.py` | `dz-number.js` | yes | no | no | **DOM-only** |
...
| `progress_bar` | `progress_bar.py` | `—` | yes | yes | yes | **schema+DOM** |
...
| `search_box` | `search_box.py` | `dz-search-box.js` | yes | yes | yes | **schema+DOM** |
...
| `swap_identity` | `swap_identity.py` | `—` | yes | no | no | **deferred** |
...
| `time` | `time.py` | `dz-time.js` | yes | no | no | **DOM-only** |
| `time_series` | `time_series.py` | `—` | yes | yes | yes | **schema+DOM** |
| `timeline` | `timeline.py` | `—` | yes | yes | yes | **schema+DOM** |
| `toast` | `toast.py` | `dz-toast.js` | yes | no | no | **DOM-only** |
| `toggle` | `toggle.py` | `dz-toggle.js` | yes | no | no | **DOM-only** |
