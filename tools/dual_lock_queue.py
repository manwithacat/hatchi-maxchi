...
_EMIT_TO_STEM: dict[str, str] = {
    ...
    "_emit_activity_feed": "activity_feed_list",
    ...
    # Wire remaining dual-locked stems (contracts already ship; map closes queue gaps)
    "_emit_pivot_table_region": "pivot",
    "_emit_tabs": "tabs",
    "_emit_color_field": "color",
    "_emit_slider_field": "slider",
    "_emit_tags_field": "tags",
    "_emit_combobox": "combobox",
    "_emit_money": "money",
    "_emit_search_select": "search_select",
    ...
    "_emit_box_plot": "box_plot",
    "_emit_bullet": "bullet",
    "_emit_funnel": "funnel",
    "_emit_heatmap": "heatmap",
    "_emit_histogram": "histogram",
    "_emit_radar": "radar",
    "_emit_sparkline": "sparkline",
