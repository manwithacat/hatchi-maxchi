...
""",
        ...
        Hyperpart(
            ...
            '<span class="dz-date-range-group">'
            ...
            '<input data-dz-date-iso class="dz-date-range-iso" type="text" '
            'spellcheck="false" autocomplete="off" '
            'aria-label="From ISO date" value="2026-06-01">'
            "</span>"
            ...
            '<input data-dz-date-iso class="dz-date-range-iso" type="text" '
            'spellcheck="false" autocomplete="off" '
            'aria-label="To ISO date" value="2026-06-30">'
            "</span>"
            '<div id="hm-dr-out" hidden></div>'
            "</div>",
            notes="Dual-lock root is <code>data-dz-date-range</code> "
            "(<code>contracts/date_range.py</code>). Native "
            "<code>type=&quot;date&quot;</code> is the submitted value "
            "(ISO companion has no <code>name</code>). Each date input "
            "fires the region's hx-get on change and "
            ...
            "Leftover ISO junk must not invent a bound (cycle 2139).",
            tags=("forms", "htmx"),
            ...
            guidance=Guidance(
                ...
                do_dont=(
                    (
                        "write a valid companion ISO into the date; refuse leftover junk",
        ...
        Hyperpart(
            ...
            'data-dz-from-state="open" data-dz-rank="1000" data-dz-allowed-to="in_progress done" '
            'draggable="true">'
            ...
            'data-dz-from-state="open" data-dz-rank="2000" data-dz-allowed-to="in_progress" '
            'draggable="true">'
            '<div class="dz-kanban-card-body">'
            ...
            'data-dz-from-state="in_progress" data-dz-rank="1000" data-dz-allowed-to="done open" '
            'draggable="true">'
            '<div class="dz-kanban-card-body">'
        ...
        Hyperpart(
            ...
            "Leftover-honest <code>include_closed</code> / <code>as_of</code> "
            "ride <code>data-dz-csv-endpoint</code> (cycle 2174); the bare "
            "path invented open-only / current CSV. Sortable headers are "
            "<code>dz-list-sort-link</code> anchors with "
